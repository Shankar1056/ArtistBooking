...
public class VideoYAdapter extends RecyclerView.Adapter<VideoYAdapter.ViewHolder> {
    private final OnVideoItemListener listener;
    private ArrayList<VideoObj> models;


    public VideoYAdapter(ArrayList<VideoObj> models, OnVideoItemListener listener) {
        this.models = models;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_y_video, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemRV.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                listener.onVideo(model,position);
            }
        });
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements RippleView.OnRippleCompleteListener {
        ...
        ViewHolder(View itemView) {
            ...
            tv_title = (TextView) itemView.findViewById(R.id.tv_type);
