    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemRV.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                rippleView.getContext().startActivity(new Intent(rippleView.getContext(), ArtistsActivity.class).putExtra(JsonParser.SUB_NAME,model.getTitle()).putExtra(JsonParser.SUB_CAT_ID,model.getId()));
            }
        });
