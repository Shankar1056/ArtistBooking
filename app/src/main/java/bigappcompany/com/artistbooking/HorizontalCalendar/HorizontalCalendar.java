package bigappcompany.com.artistbooking.HorizontalCalendar;
...
public class HorizontalCalendar {
    ...
    public HorizontalCalendarAdapter getmCalendarAdapter()
    {
    ...
    public void adjustCalendarLocation() {
        ...
        if (position != -1) {
            ...
            calendarView.getLayoutManager().scrollToPosition(position - shiftCells);
        }
